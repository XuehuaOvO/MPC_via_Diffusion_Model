...
The video and figure below illustrate the control process (played at 3× speed on GitHub compared to real-time) and show the resulting trajectory of the Franka Panda gripper base.
